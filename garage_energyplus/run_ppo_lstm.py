...
from garage_energyplus.policies import GaussianLSTMPolicy
...
EplusYearEnv.configure(
    ...
    log_dir="eplog/ppo-year-lstm",
    seed=42,
    verbose=False,
    max_episode_steps=2880,
)

@wrap_experiment(log_dir="./data/local/garage/eplus_ppo_year_lstm", snapshot_mode="none")
